-- ============================================================================
-- UC Function Wrapper: get_critical_queries (Managed MCP Compatible)
-- Purpose: JSON wrapper around critical_queries view for managed MCP integration
-- Author: Claude Code AI Assistant  
-- Version: 1.0 (Managed MCP test function)
-- ============================================================================
...
-- This function returns JSON that can be consumed by Claude via managed MCP
-- ============================================================================